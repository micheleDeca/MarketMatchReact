...
export const refuseReservationUpdater = async (reservationUuid, setUpdatePage) => {

        const token = getToken();

        try {
            const response = await axios.get(
                `${BASE_URL}/api/reservation/refuseReservation`,
            ...
            if(data.successCode === "RESERVATION_REFUSED")
                setUpdatePage();
