...
const Stelle = (props) => {
   return (
    <div>
      <StarIcon size={"25px"} color={props.starNumber >= 1 ? "#FFE414" : "#1E1E1E"} />
      <StarIcon size={"25px"} color={props.starNumber >= 2 ? "#FFE414" : "#1E1E1E"} />
      <StarIcon size={"25px"} color={props.starNumber >= 3 ? "#FFE414" : "#1E1E1E"} />
      <StarIcon size={"25px"} color={props.starNumber >= 4 ? "#FFE414" : "#1E1E1E"} />
      <StarIcon size={"25px"} color={props.starNumber >= 5 ? "#FFE414" : "#1E1E1E"} />
    </div>
  )
}
