...
/**
 * Componente React per la pagina di login. Permette agli utenti di autenticarsi
 * verificando che i campi richiesti siano compilati e utilizzando una funzione
 * di login per gestire la validazione e l'autenticazione.
 *
 * @returns {JSX.Element} Un modulo di login con gestione dello stato e navigazione.
 */
