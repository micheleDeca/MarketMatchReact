...
function Ricetta() {
    ...
    const [ricettaInfo, setRicettaInfo] = useState({
        ...
        Passaggi: [
            {
                Titolo: "Preparare i funghi porcini",
                Descrizione: "Pulire accuratamente i funghi porcini con un panno umido per rimuovere ogni residuo di terra e tagliarli a fette sottili.",
                Foto: "risotto_funghi/1.png"
            },
            {
                Titolo: "Soffriggere la cipolla",
                Descrizione: "Tritare finemente la cipolla e soffriggerla a fuoco medio in una padella con olio extravergine d'oliva fino a doratura leggera.",
                Foto: "risotto_funghi/2.png"
            },
            {
                Titolo: "Cuocere i funghi",
                Descrizione: "Aggiungere i funghi porcini nella padella con la cipolla e cuocere per circa 5 minuti, mescolando di tanto in tanto.",
                Foto: "risotto_funghi/3.png"
            },
        ],
    });
    return (
