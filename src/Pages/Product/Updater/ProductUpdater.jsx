...
export const fetchProductUpdater = async (page, productsPerPage) => {
    if (IS_MOCKKED) {
        // Simula un ritardo per i dati mock
        return new Promise((resolve) => {
            setTimeout(() => {
                const data = getMockProductsByPage(page, productsPerPage);
                resolve(data);
        ...
        try {
            const response = await axios.get(`${BASE_URL}/api/product/unfiltered`, {
                headers: {
